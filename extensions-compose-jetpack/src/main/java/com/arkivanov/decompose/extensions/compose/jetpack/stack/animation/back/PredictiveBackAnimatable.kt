package com.arkivanov.decompose.extensions.compose.jetpack.stack.animation.back
...
fun PredictiveBackAnimatable(
    ...
    object : AbstractPredictiveBackAnimatable(initialBackEvent) {
        override val enterModifier: Modifier get() = enterModifier(progress, swipeEdge)
        override val exitModifier: Modifier get() = exitModifier(progress, swipeEdge)
    }
